...
const VfsBrowser = dynamic(() => import("@/components/vfs-browser").then((m) => ({ default: m.VfsBrowser })), { ssr: false });
    ...
    <ErrorBoundary>
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Toolbar - hide for transfer sections and VFS browser mode */}
          {section !== "quick-transfer" && section !== "transfer-station" && !(vfsMode && section === "files") && <FileToolbar />}
