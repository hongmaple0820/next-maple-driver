...
export type DialogAnimationVariant = "default" | "spring" | "slide-up" | "scale-fade" | "slide-right"

const dialogAnimations: Record<DialogAnimationVariant, {
...
function DialogContent({
  ...
  animation?: DialogAnimationVariant
}) {
